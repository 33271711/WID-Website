...
<br>
    ...
    <div class="row">
    <div class="col-md-3">
	<img src="<?php echo get_template_directory_uri(); ?>/images/Dr%20Jacinta%20Vu%202.jpg" alt="Profile1" class="profile">
    ...
    <div class="col-md-3">
    <img src="<?php echo get_template_directory_uri(); ?>/images/Dr%20Lucy%20De%20Jesus%202.jpg" alt="Profile2" class="profile">
    ...
    <div class="col-md-3">
    <img src="<?php echo get_template_directory_uri(); ?>/images/Dr%20Rebecca%20Williams%202.jpg" alt="Profile3" class="profile">
    ...
    <div class="col-md-3">
    <img src="<?php echo get_template_directory_uri(); ?>/images/Dr%20Jippy%20Buck%202.jpg" alt="Profile4" class="profile"> 
